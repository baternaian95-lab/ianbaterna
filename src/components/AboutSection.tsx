...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 sm:py-24 lg:py-32 px-5 sm:px-6">
      <div className="container max-w-6xl">
        ...
        >
          <p className="text-primary font-display font-medium tracking-wider uppercase text-xs sm:text-sm mb-3">About Me</p>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-semibold mb-5 sm:mb-8">
            Digital Experiences
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {skills.map((skill, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="glass-card rounded-xl p-5 sm:p-6 hover:border-primary/40 transition-colors group hover-lift relative overflow-hidden"
            >
